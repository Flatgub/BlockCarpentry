...
public class Registration {
    ...
    //fixme or deleteme
    //public static final RegistryObject<FallingFrameBlock> FALLING_FRAMEBLOCK = BLOCKS.register("falling_frameblock", () -> new FallingFrameBlock(Block.Properties.copy(FRAMEBLOCK.get())));
    //public static final RegistryObject<Item> FALLING_FRAMEBLOCK_ITEM = ITEMS.register("falling_frameblock", () -> new BlockItem(FALLING_FRAMEBLOCK.get(), new Item.Properties().tab(BlockCarpentryMain.BlockCarpentryItemGroup.BLOCK_CARPENTRY)));
    //public static final RegistryObject<BlockEntityType<FrameBlockTile>> FALLING_FRAMEBLOCK_TILE = TILES.register("falling_frameblock", () -> BlockEntityType.Builder.create(FrameBlockTile::new, FRAMEBLOCK.get()).build(null));
    ...
    public static final RegistryObject<PoiType> BED_FRAME_POI = POI_TYPES.register("frame_bed", () -> new PointOfInterestType("frame_bed_poit", PointOfInterestType.getAllStates(Registration.BED_FRAMEBLOCK.get()), 1,1));
    ...
    public static final RegistryObject<MenuType<ChestFrameContainer>> CHEST_FRAME_CONTAINER = CONTAINERS.register("frame_chest", () -> IForgeContainerType.of(ChestFrameContainer::new));
    ...
    public static final RegistryObject<PoiType> BED_ILLUSION_POI = POI_TYPES.register("illusion_bed", () -> new PointOfInterestType("illusion_bed", PointOfInterestType.getAllStates(Registration.BED_ILLUSIONBLOCK.get()), 1, PointOfInterestType.MATCH_ANY, 1));
